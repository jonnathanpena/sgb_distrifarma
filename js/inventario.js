...
function generate_table() {
    ...
    $.each(displayRecords, function(index, row) {
        ...
        tr.append("<td class='text-right'>" + Number(row.df_ppp_ind).toFixed(2) + "</td>");
        tr.append("<td class='text-right'>" + Number(row.df_pvt_ind).toFixed(2) + "</td>");
        tr.append("<td class='text-right'>" + Number((row.df_cant_bodega * 1) * (row.df_ppp_ind * 1)).toFixed(2) + "</td>");
        tr.append("<td class='text-right'>" + Number((row.df_cant_bodega * 1) * (row.df_pvt_ind * 1)).toFixed(2) + "</td>");    
